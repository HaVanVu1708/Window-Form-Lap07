using ObservableCollection2.Models;
using System;
...
namespace ObservableCollection2
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private ObservableCollection2<Contact> Contacts;
        public MainPage()
        {
            ...
            Contact = new ObservableCollection2<Contact>();
            Contact.Add(new Contact { FirstName = " Van Vu", LastName = "Ha", AvatarPath = "Assets/female-01.png" });
            Contact.Add(new Contact { FirstName = " Tung Lam", LastName = "Pham", AvatarPath = "Assets/female-01.png" });
